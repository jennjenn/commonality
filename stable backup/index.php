...
<div id="indextext">
	...
	<p><em><u>it's pretty simple</u>: you'll be given a series of 10 photos, each with a list of tags. select the tags you think should be associated with that photo and click the "tag" button. that's it!</em></p>
	<p><em>you can add as many or as few tag as you want. there are no right or wrong answers.</em></p>
